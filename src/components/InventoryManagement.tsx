        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl p-6 text-white">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-semibold opacity-90">Total Sales Income</h3>
              <TrendingUp className="h-6 w-6 opacity-80" />
            </div>
            <p className="text-3xl font-bold mb-2">{formatPrice(stats.totalSales)}</p>
            <p className="text-sm opacity-90">Vials Sold: {stats.vialsSold}</p>
          </div>

          {/* Inventory Value */}
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-xl p-6 text-white">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-semibold opacity-90">Inventory Value</h3>
              <Package className="h-6 w-6 opacity-80" />
            </div>
            <p className="text-3xl font-bold mb-2">{formatPrice(stats.inventoryValue)}</p>
            <p className="text-sm opacity-90">Total Items: {stats.totalItems}</p>
          </div>

          {/* Low Stock */}
          <div className="bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl shadow-xl p-6 text-white">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-semibold opacity-90">Low Stock</h3>
              <AlertTriangle className="h-6 w-6 opacity-80" />
            </div>
            <p className="text-3xl font-bold mb-2">{stats.lowStockCount}</p>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-4 mb-6 border-2 border-blue-100">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-2 rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all flex items-center gap-2"
            >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          <p className="text-gray-500 mb-1">Price per Vial</p>
                          <p className="font-semibold text-gray-900">{formatPrice(product.base_price)}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-blue-600">{formatPrice(totalValue)}</p>
                        </div>
                        <div>
                    ...
                    <div className="flex flex-col gap-2 md:w-auto">
                      <button
                        ...
                        className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-2 rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all"
                      >
                        Sell
                      </button>
                      <button
                        onClick={() => handleEdit(product)}
                        className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-2 rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => handleDelete(product)}
                        className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-6 py-2 rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all"
                      >
                        Delete
                      </button>
                    </div>
